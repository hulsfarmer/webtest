...
const userImagePaths = [
  '/tmp/shot1_hero.png',
  '/tmp/shot2_process.png',
  '/tmp/shot3_howitworks.png',
  '/tmp/shot4_features.png',
  '/tmp/shot5_pricing.png',
];
...
console.log('[4/4] Generating video with screenshots...');
await generateVideo(
...
console.log('Done!');
console.log('URL: https://shortsai.kr/api/video/' + jobId);
