...
- **각 문장에 어울리는 이모지를 1개 정도** 자연스럽게 넣어 재미·시선을 더해줘 (과하지 않게, hook·핵심 포인트 위주, 문장 끝이나 강조 단어 옆에)
...
- **각 문장에 어울리는 이모지를 1개 정도** 자연스럽게 넣어 재미·시선을 더해줘 (과하지 않게, hook·핵심 위주)
...
- 각 문장에 어울리는 이모지를 1개 정도 자연스럽게 넣어 재미·시선을 더해줘 (과하지 않게)`,
          },
        ],
      },
    ],
