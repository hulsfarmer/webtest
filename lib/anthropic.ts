...
- **각 문장에서 가장 핵심이 되는 단어·구절 하나를 별표(*)로 감싸** 강조 표시해줘 (예: '매일 *직접 구운* 빵'). 문장당 딱 1곳, 짧게(2~6자)
...
- **각 문장에서 가장 핵심이 되는 단어·구절 하나를 별표(*)로 감싸** 강조 표시해줘 (예: '이번 주말 *단 이틀*'). 문장당 딱 1곳, 짧게(2~6자)
...
- 각 문장에 어울리는 이모지를 1개 정도 자연스럽게 넣어 재미·시선을 더해줘 (과하지 않게, 이모지 앞뒤에는 반드시 띄어쓰기)
- 각 문장에서 가장 핵심이 되는 단어·구절 하나를 별표(*)로 감싸 강조 표시해줘 (예: '매일 *직접 구운* 빵'). 문장당 딱 1곳, 짧게`,
          },
        ],
      },
    ],
