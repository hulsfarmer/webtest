...
- ⭐ **쉬운 홍보 언어 필수**: 핵심 홍보 포인트에 담긴 전문용어·성분명·기술 스펙을 그대로 옮기지 마세요. 처음 보는 고객이 바로 이해하는 **쉬운 일상어**로 바꾸고, 어려운 말은 "그래서 뭐가 좋아지는지(고객 혜택·느낌)"로 풀어서 표현하세요 (예: '고농축 세라마이드 함유' → '피부가 속부터 촉촉하게', '저온 숙성 공법' → '더 깊고 진한 맛'). 스펙 나열이 아니라 **혜택·느낌 중심**의 광고 문구로.
...
- ⭐ **쉬운 홍보 언어 필수**: 어려운 전문용어·딱딱한 표현은 처음 오는 사람도 바로 이해하는 쉬운 말로 풀고, "참여하면 뭐가 좋은지(즐길거리·혜택·설렘)" 중심으로 표현하세요.
