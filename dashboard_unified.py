...
<!-- 탭 -->
<div class="tabs">
  <div class="tab active" onclick="switchTab('testa', this)">📈 테스타 v2 스윙봇</div>
  <div class="tab" onclick="switchTab('paper', this)">⚡ 단타 가상거래봇</div>
  <div class="tab" onclick="switchTab('bear', this)">🐻 BearHunter</div>
</div>

<!-- ══ 테스타 v2 패널 ══════════════════════════════════ -->
<div id="panel-testa" class="panel active">
  <div class="cards">
