...
const CARDS: { icon: string; name: string; desc: string; href: string; tag?: 'new' | 'soon'; adminOnly?: boolean }[] = [
  ...
  { icon: '📅', name: '이벤트 소개 영상', desc: '축제·마켓·세일·오픈 등 이벤트를 긴급성 있게 알립니다.', href: '/studio/event' },
  { icon: '🎭', name: '제품 소개 영상 (캐릭터)', desc: '말하는 캐릭터가 제품을 직접 소개하는 드라마형 쇼츠.', href: '/studio/product-vs' },
  { icon: '⭐', name: '제품 소개 영상 (AI배우) ⭐', desc: '제품을 든 AI배우를 자동 생성해 20초로 말하게 하는 쇼츠. 제품 이미지·홍보문구만 넣으면 배우·목소리·길이 모두 자동. (1편 15크레딧)', href: '/studio/product-ai' },
