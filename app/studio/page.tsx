...
const CARDS = [
  ...
  { icon: '🎭', name: '제품 홍보영상', desc: '말하는 캐릭터가 제품을 직접 소개하는 드라마형 쇼츠.', href: '/studio/product-vs', tag: 'new' as const, adminOnly: true },
  { icon: '🎬', name: '제품 홍보영상 (고급)', desc: '고급 립싱크 엔진(Kling) 버전. 세밀한 표정이 필요할 때.', href: '/studio/product', adminOnly: true },
