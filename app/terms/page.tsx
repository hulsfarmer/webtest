  ...
  return (
    <main className="max-w-3xl mx-auto px-5 sm:px-6 py-14 sm:py-20 text-gray-300 leading-relaxed">
      ...
      <Section title="제4조 (서비스의 제공)">
        ...
        <p>2. 요금제별 월 생성 횟수 및 기능은 서비스 내 요금 안내에 따릅니다(무료 월 3회, Pro 월 30회, Business 월 100회).</p>
      ...
      <Section title="제6조 (이용요금 및 결제)">
        <p>1. 유료서비스는 월 정기결제(자동갱신) 방식으로 제공되며, 요금은 Pro 월 5,000원, Business 월 14,500원입니다(부가세 별도, 결제 시 부가세 10% 추가).</p>
