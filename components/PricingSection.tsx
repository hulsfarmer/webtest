...
// 단건(크레딧) 팩 — PortOne 일반결제(requestPayment). 채널키 설정 시에만 노출. 크레딧당 200원.
const ONETIME_CHANNEL_KEY = process.env.NEXT_PUBLIC_PORTONE_CHANNEL_KEY_ONETIME;
const CREDIT_PACKS = [
  { id: 'credit10', label: '10크레딧', credits: 10, amount: 2000, badge: null as string | null },
  { id: 'credit25', label: '25크레딧', credits: 25, amount: 5000, badge: '인기' as string | null },
  { id: 'credit60', label: '60크레딧', credits: 60, amount: 12000, badge: null as string | null },
];
